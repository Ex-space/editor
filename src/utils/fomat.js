...
!function(l) {
    "use strict";
    var e, r, t, n, o, m, i, d, a, u, c, v, s, g = function(e) {
        var r = e
          , t = function() {
            return r
        };
        ...
        var t
    }, S = function() {}, O = function(e) {
        return function() {
            return e
        }
    }, N = O(!1), w = O(!0), T = function() {
        return x(0, 0)
    }, x = function(e, r) {
        return {
            major: e,
        ...
        detect: function(e, r) {
            ...
            return 0 === e.length ? T() : function(e, r) {
                var t = function(e, r) {
        ...
        unknown: T
    }, k = "Edge", A = "Chrome", _ = "Opera", D = "Firefox", C = "Safari", L = function(e, r) {
        return function() {
            return r === e
        }
    }, P = function(e) {
        ...
        firefox: O(D),
        safari: O(C)
    }, I = "Windows", F = "Android", M = "Linux", B = "Solaris", j = "FreeBSD", U = function(e, r) {
        return function() {
            return r === e
        }
    }, V = function(e) {
    ...
    }, G = Y("string"), $ = Y("array"), K = Y("boolean"), Z = Y("function"), J = Y("number"), Q = Array.prototype.slice, ee = Array.prototype.indexOf, re = Array.prototype.push, te = function(e, r) {
        return t = e,
        n = r,
        -1 < ee.call(t, n);
        var t, n
    ...
    function(e, r) {
    ...
    }, me = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, de = function(r) {
        return function(e) {
            return le(e, r)
        }
    }, ve = [{
        ...
        var t, n, o, i, a, u, c, s, f, l, m, d, v = pe.browsers(), g = pe.oses(), p = se(v, e).fold(R.unknown, R.nu), h = fe(g, e).fold(q.unknown, q.nu);
        return {
            browser: p,
            os: h,
            deviceType: (n = p,
        ...
        return he.get()
    }, ye = Object.keys, Se = Object.hasOwnProperty, Oe = function(e, r) {
        ...
        return Se.call(e, r)
    }, Ee = (l.Node.ATTRIBUTE_NODE,
    l.Node.CDATA_SECTION_NODE,
    l.Node.COMMENT_NODE,
    l.Node.DOCUMENT_NODE,
    l.Node.DOCUMENT_TYPE_NODE,
    l.Node.DOCUMENT_FRAGMENT_NODE,
    l.Node.ELEMENT_NODE), ke = l.Node.TEXT_NODE, Ae = (l.Node.PROCESSING_INSTRUCTION_NODE,
    ...
    function(e) {
        ...
        !function(e, r, t) {
            if (!(G(t) || K(t) || J(t)))
                throw l.console.error("Invalid call to Attr.set. Key ", r, ":: Value ", t, ":: Element ", e),
        ...
        return o = r,
        i = Le(t = e, n = "class").concat([o]),
        _e(t, n, i.join(" ")),
        !0;
        var t, n, o, i
    }, Fe = function(e, r) {
        return o = r,
        0 < (i = ie(Le(t = e, n = "class"), function(e) {
            return e !== o
        })).length ? _e(t, n, i.join(" ")) : Ce(t, n),
        !1;
        var t, n, o, i
    }, Me = function(e, r) {
        var t;
    ...
    var Ve = function(e) {
        var r, t;
        r = je.fromDom(e.getBody()),
        t = "tox-cursor-format-painter",
        Pe(r) ? r.dom().classList.add(t) : Ie(r, t)
    }
      , qe = function(e, r) {
        var t;
        t = e,
        Me(je.fromDom(t.getBody()), "tox-cursor-format-painter"),
        r.set(m.Retrival),
        Ue(e, !1)
    }
      , ze = function(e, r) {
        r.get() === m.Application ? qe(e, r) : function(r, t) {
            var n = be()
              , o = g(!1);
            Ve(r),
            t.set(m.Application),
            ...
            var i = function() {
              ...
              , e = function() {
                t.get() === m.Application && i(),
                s()
            }
              , a = function(e) {
                t.get() === m.Application && ("touchcancel" === e.type && n.os.isAndroid() ? r.once("contextmenu", i) : o.get() ? i() : r.once("selectionchange", i)),
                s()
            }
              , u = function(e) {
                27 === e.keyCode && (qe(r, t),
    ...
    var $e = function(e, r, t) {
      ...
      , Ke = function(e, r, t) {
        ...
        function(e, r) {
            return r(e)
        }(o = e, i = r) ? W.some(o) : Z(a) && a(o) ? W.none() : n(o, i, a)
    }
      , Ze = {
      ...
      , nr = function(e, r) {
        return ne(e.formatter.get(r), function(e) {
            return t = Te(r = e, "styles").exists(function(e) {
                return ne(we(e), tr)
            }),
      ...
      , ar = function(e, r, t) {
        var n, o = e.formatter, i = er(e, t.formatName), a = rr(e, o, t.formatName), u = (n = t.formatName,
        te(["formatpainter_borderstyle", "formatpainter_bordercolor", "formatpainter_backgroundcolor"], n));
      ...
      , sr = function(n, e) {
        ...
        var o, i, a, u, c, s, f = (a = (o = n).selection.getStart(),
        ...
        e.schemas.forEach(function(e) {
            ...
            case d.ListSchema:
                r = n,
                t = e,
                f.block && r.execCommand(t.command);
                break;
      ...
      , fr = function(e) {
        return Pe(e) ? function(e) {
            for (var r = e.dom().classList, t = new Array(r.length), n = 0; n < r.length; n++)
                t[n] = r.item(n);
            return t
        }(e) : Re(e)
    }
      , lr = function(e, r) {
        var t, n, o = e.dom(), i = l.window.getComputedStyle(o).getPropertyValue(r), a = "" !== i || null != (n = Ae(t = e) ? t.dom().parentNode : t.dom()) && n.ownerDocument.body.contains(n) ? i : mr(o, r);
      ...
      , gr = function(o, e) {
        return Ne(e, function(e, r) {
            return {
                ...
                v: (t = o,
                n = r,
                "class" === n ? fr(t).filter(function(e) {
                    return !/^(mce-.*)/.test(e)
                }).join(" ") : De(t, n))
            };
            var t, n
      ...
      , br = function(e, r, t) {
        return (n = e.get(r),
        0 === n.length ? W.none() : W.some(n[0])).bind(function(e) {
            return hr(e, t)
        }).map(function(e) {
            return {
      ...
      , Or = function(e) {
        var r, t, n, o, i, a = e.dom, u = e.selection.getStart();
        return {
            schemas: vr(Sr(e).toArray(), (n = e,
            o = u,
            ...
            context: (r = a,
            t = u,
            r.getParent(t, "TABLE") ? v.Table : v.Unspecified)
        }
    }
      , Nr = function(e) {
        if (y(tinymce, "4.9.0"))
            ...
            {};
        var t, r, n, o, i, a, u, c, s = g(m.Retrival), f = g({
            schemas: [],
            context: v.Unspecified
        });
        return (t = e).on("PreInit", function() {
            Oe(Ze, function(e, r) {
